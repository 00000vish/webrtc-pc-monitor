...
const AudioHeader = dynamic(() => import("../../../components/audio"), { ssr: false });
const CameraHeader = dynamic(() => import("../../../components/video"), { ssr: false });
const ScreenHeader = dynamic(() => import("../../../components/video"), { ssr: false });
const TerminalHeader = dynamic(() => import("../../../components/terminal"), { ssr: false });
...
export default function Machine({ machine }){
    ...
    useEffect(() => {
        const connectMachine = async () => {
            ...
            var found = await ServerBackend.SendConnectCommand(machine, offer, "all");
            if (found == null){
    ...
    return (
        <div>
            ...
            <AudioHeader clientData={machine} webrtcClient={webrtcClient}/>
            <ScreenHeader clientData={machine} webrtcClient={webrtcClient}/>
            <TerminalHeader clientData={machine} webrtcClient={webrtcClient} />
        </div>
    )        
}
